...
const SpaceManagement = () => {
  ...
  const handleCreateSpace = async () => {
    try {
      const response = await axios.post(`https://api.w-space.site/api/spaces`, newSpace);
  ...
  const handleUpdateSpace = async () => {
    try {
      const response = await axios.put(`https://api.w-space.site/api/spaces/${editingSpace._id}`, editingSpace);
  ...
  const handleDeleteSpace = async (spaceId) => {
    try {
      await axios.delete(`https://api.w-space.site/api/spaces/${spaceId}`);
