        ...
        <nav className="navbar-fixed bg-white p-4 flex justify-between items-center border-b-2 border-gray-300 font-bold">
            <div className="flex items-center space-x-8 ml-[160px]">
                ...
                <div className="flex space-x-[50px] px-[30px]">
                    <Link to="/admin" className="relative hover-underline">Home</Link>
                    <Link to="/admin/spaces" className="relative hover-underline">Space</Link>
                    <Link to="/admin/bookings" className="relative hover-underline">Booking</Link>
                </div>
            </div>
